              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h2 text-gray-900 mb-4">Validasi Pendaftaran Kegiatan Magang</h1>
                  </div>
                  <form class="user" action="/kaprodi/vlmagang/{{ $Magang['id'] }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @if(session('errors'))
                    ...
                    <label class="col-sm-7 col-form-label font-weight-bold text-gray-800">Nama Mahasiswa</label>
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="nama_mitra" aria-describedby="emailHelp" value="{{ old('nama_mitra') ? old('nama_mitra') : $Magang['nama_mitra'] }}">
                      </div>
