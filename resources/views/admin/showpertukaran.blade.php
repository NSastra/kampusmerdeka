              ...
              <div class="table-responsive">
                ...
                <div class="dropdown mb-4">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="/admin/printptk2122" target="__blank">Tahun Ajaran 2021/2022</a>
                    <a class="dropdown-item" href="/admin/printptk2223" target="__blank">Tahun Ajaran 2022/2023</a>
                  </div>
                </div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> {{ $ptk['status'] }} </td>
                      <td> <a class="btn btn-warning" href="/admin/showeditptk/{{ $ptk['id'] }}"> Edit Data </a> </td>
                      <td> <form action="/admin/hapusptk/{{ $ptk['id'] }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger" type="submit"> Hapus Data </button> </form></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="user" action="/admin/createptk" method="post">
        @csrf
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="type" class="form-control" name="kegiatan" value="Pertukaran Pelajar">
          </div>
        </div>
        <div class="row mb-3">
