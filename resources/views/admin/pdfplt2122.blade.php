...
<body>
    ...
    <h2 align="center"> Laporan Pendaftaran Kegiatan Penelitian <br/> Prodi Sistem Informasi <br/> Universitas Catur Insan Cendekia <br/> Tahun Ajaran 2021/2022</h2>
    ...
    <br/>
    Berdasarkan data tersebut, dapat diketahui bahwa sampai tanggal @php echo date('d/m/Y'); @endphp jumlah mahasiswa yang mendaftar pada kegiatan penelitian adalah sebanyak
