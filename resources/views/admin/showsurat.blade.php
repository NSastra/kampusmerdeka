...
<h1 class="h3 mb-2 text-gray-800" align="center">Surat Persetujuan</h1>
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      {{-- <td> <img src="{{ asset('img/' . $srt->gambar) }}" width="250" height="250"> </td> --}}
                      <td> {{ $srt['name'] }} </td>
                      <td> {{ $srt['nim'] }} </td>
                      <td> {{ $srt['nama_mhs'] }} </td>
                      <td> {{ $srt['semester'] }} </td>
                      <td> {{ $srt['kelas'] }} </td>
                      <td> <a class="btn btn-warning" href="/admin/showeditsurat/{{ $srt['id'] }}"> Edit Data </a> </td>
                      <td> <form action="/admin/hapussurat/{{ $srt['id'] }}" method="post">
                          @csrf
                          @method('DELETE')
