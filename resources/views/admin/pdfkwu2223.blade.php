...
<body>
    ...
    <h2 align="center"> Laporan Pendaftaran Kegiatan Kewirausahaan <br/> Prodi Sistem Informasi <br/> Universitas Catur Insan Cendekia <br/> Tahun Ajaran 2022/2023</h2>
    ...
    Berdasarkan data tersebut, dapat diketahui bahwa sampai tanggal @php echo date('d/m/Y'); @endphp jumlah mahasiswa program studi sistem informasi yang mendaftar pada kegiatan kewirausahaan adalah sebanyak
