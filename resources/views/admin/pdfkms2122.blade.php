...
<body>
    ...
    <h2 align="center"> Laporan Pendaftaran Kegiatan Proyek Kemanusiaan <br/> Prodi Sistem Informasi <br/> Universitas Catur Insan Cendekia <br/> Tahun Ajaran 2021/2022</h2>
    {{-- <img src="{{ url('img/cic.png') }}"> --}}
    <p> Berikut ini terlampir data pendaftaran kegiatan proyek kemanusiaan yang dilakukan oleh para mahasiswa/i Program Studi Sistem Informasi di Univeristas Catur Insan Cendekia : <br/> </p>
    ...
    <br/>
    Berdasarkan data tersebut, dapat diketahui bahwa sampai tanggal @php echo date('d/m/Y'); @endphp jumlah mahasiswa yang mendaftar pada kegiatan proyek kemanusiaan adalah sebanyak
