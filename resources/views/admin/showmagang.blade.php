              ...
              <div class="table-responsive">
                ...
                <div class="dropdown mb-4">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="/admin/printmagang2122" target="__blank">Tahun Ajaran 2021/2022</a>
                    <a class="dropdown-item" href="/admin/printmagang2223" target="__blank">Tahun Ajaran 2022/2023</a>
                  </div>
                </div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> {{ $magang['status'] }} </td>
                      <td> <a class="btn btn-warning" href="/admin/showeditmagang/{{ $magang['id'] }}"> Edit Data </a> </td>
                      <td> <form action="/admin/hapusmagang/{{ $magang['id'] }}" method="post">
                          @csrf
                          @method('DELETE')
    ...
    <div class="modal-content">
      ...
      <form class="user" action="/admin/createmagang" method="post">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="type" class="form-control" name="kegiatan" value="Magang">
          </div>
        </div>
        <div class="row mb-3">
