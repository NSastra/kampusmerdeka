              ...
              <div class="table-responsive">
                ...
                <div class="dropdown mb-4">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="/admin/printstudi2122" target="__blank">Tahun Ajaran 2021/2022</a>
                    <a class="dropdown-item" href="/admin/printstudi2223" target="__blank">Tahun Ajaran 2022/2023</a>
                  </div>
                </div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> {{ $Studi['status'] }} </td>
                      <td> <a class="btn btn-warning" href="/admin/showeditstudi/{{ $Studi['id'] }}"> Edit Data </a></td>
                      <td> <form action="/admin/hapusstudi/{{ $Studi['id'] }}" method="post">
                        @csrf
                        @method('DELETE')
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="user" action="/admin/createstudi" method="post">
        @csrf
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="type" class="form-control" name="kegiatan" value="Studi Independen">
          </div>
        </div>
        <div class="row mb-3">
