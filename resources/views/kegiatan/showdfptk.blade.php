...
@section('title', 'Pendaftaran Kegiatan Pertukaran Pelajar')
...
<section class="page-section" id="contact">
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                <form action="/kegiatan/dfptk" method="post">
                  @csrf
                    {{-- <!-- Email address input-->
                    ...
                    <!-- Email address input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" id="kegiatan" type="text" placeholder="name@example.com" data-sb-validations="required,kegiatan" name="kegiatan" value="Pertukaran Pelajar" />
                    ...
                    <!-- Email address input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" id="nama_mitra" type="text" placeholder="name@example.com" data-sb-validations="required,nama_mitra" name="nama_mitra" value="{{ old('nama_mitra') ? old('nama_mitra') : $Mitraptk['nama_mitra'] }}" />
