...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Halaman Profile Mahasiswa
      <small></small>
    </h1>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
            ...
            <a href="/mahasiswa/statusdaftar" class="list-group-item">Status Pendaftaran</a>
            <a href="/mahasiswa/showeditprofil" class="list-group-item">Update Profile</a>
            <a href="/mahasiswa/showchangepw" class="list-group-item">Ganti Password</a>
        </div>
      </div>
      <!-- Content Column -->
