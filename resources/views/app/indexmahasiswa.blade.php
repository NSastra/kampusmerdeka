            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#kegiatan">Daftar Kegiatan</a></li>
                        <li class="nav-item"><a class="nav-link" href="/mahasiswa/profile">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" href="/mahasiswa/logout">Logout</a></li>
                    </ul>
                </div>
            </div>
        </nav>
