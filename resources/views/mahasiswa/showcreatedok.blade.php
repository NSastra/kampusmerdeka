    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 col-xl-6 text-center">
                <h2 class="mt-0">Upload File Dokumen</h2>
                <hr class="divider" />
                <p class="text-muted mb-5">Silakan Upload Dokumen (Transkrip Nilai) Sebagai Persyaratan Pendaftaran Kegiatan Pada Program Kampus Merdeka</p>
            </div>
        </div>
        <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                <form action="/mahasiswa/createfile" method="post" enctype="multipart/form-data">
                  @csrf
