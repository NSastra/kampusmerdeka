...
@section('title', 'Upload Surat Persetujuan')
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 col-xl-6 text-center">
                <h2 class="mt-0">Upload File Surat Persetujuan</h2>
                <hr class="divider" />
                <p class="text-muted mb-5">Silakan Upload Surat Persetujuan Prodi Untuk Proses Validasi Pendaftaran Kegiatan Kampus Merdeka Anda</p>
            </div>
        </div>
        <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                <form action="/mahasiswa/createsurat" method="post" enctype="multipart/form-data">
                  @csrf
